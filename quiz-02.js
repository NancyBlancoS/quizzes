...
// 14. Extend the previous if statement to check if "temperature" is less than 15 and logs 'It's cold!' to the consoles.
...
console.log("[Question #33]: ", stringVar === "hello"); // should print false

// 34. Check if 'booleanVar' is truthy.

console.log("[Question #34]: ", booleanVar === "true"); 
...
console.log("[Question #36]: ", fruits.length === 3);
...
console.log("[Question #44]: ", 4 < numberVar < 6);
...
console.log("[Question #46]: ", stringVar.startsWith("H"));
...
console.log("[Question #49]: ", numberVar % 2 === 1);// should print true
...
console.log("[Question #72]: ", typeof(city) === "string");
// should print true
...
console.log("[Question #88]: ",days != 0);
...
if (circleArea > 150){
  console.log("[Question #90]: LargeCircle");
} else {
  console.log("[Question #90]: SmallCircle");
}
